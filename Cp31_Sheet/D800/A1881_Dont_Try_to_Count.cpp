...
public:
    ...
    int process(int n, int m,
        ...
        if (isSubstr(s, x)) result = 0;
        else if (isSubstr(s, x1)) result = 1;
        else if (isSubstr(s, x2)) result = 2;
        else if (isSubstr(s, x3)) result = 3;
        else if (isSubstr(s, x4)) result = 4;
        else if (isSubstr(s, x5)) result = 5;
        
        return result;
    }

    bool isSubstr(const string& s, const string& x) {
