...
public:
    ...
    string process(int a, int b, int c) {
        ...
        bool isNextTurnAnna = (c%2 == 1);
        
        if (a==b && isNextTurnAnna) result = "First";
        else if (a==b && !isNextTurnAnna) result = "Second";
        else result = (a>b) ? "First" : "Second";
