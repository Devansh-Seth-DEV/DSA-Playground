...
public:
    ...
    int process(int a, int b, int c, int d) {
        ...
        int diagDistanceToCover = abs(d-b);
        a += diagDistanceToCover;
        b += diagDistanceToCover;

        if(c>a) return -1;

        int leftDistanceToCover = abs(c-a);
        a -= leftDistanceToCover;

        result = leftDistanceToCover + diagDistanceToCover;
        return result;
    }
};
